...
const copy = {
  en: {
    eyebrow: 'Product Designer focused on AI and complex systems',
    title: ['Clarify the complexity.', 'Make the judgment tangible.'],
    intro:
    ...
    stats: [
      ...
      ['Path', 'Research → Product → AI prototypes'],
      ['Now', 'Agora · AI & real-time'],
    ],
    capabilityEyebrow: 'Four working modes',
    capabilityTitle: 'The design problems I solve',
    capabilityIntro:
      'From framing complex workflows to building systems, prototypes, and shared product clarity.',
    capabilities: [
      {
        tone: 'ux',
        label: 'UX / Complexity',
        title: 'Clarify complex experiences',
        description: 'Research, information architecture, and complex workflows.',
      },
      {
        tone: 'ui',
        label: 'UI / Systems',
        title: 'Build expressive interface systems',
        description: 'Interface design, motion, systems, and product quality.',
      },
      {
        tone: 'ai',
        label: 'AI / Design + Build',
        title: 'Make decisions testable earlier',
        description: 'Use AI-assisted prototyping to explore and validate product logic.',
      },
      {
        tone: 'leadership',
        label: 'Product collaboration',
        title: 'Create shared product clarity',
        description: 'Bring direction, constraints, and quality into cross-functional work.',
      },
    ] satisfies Capability[],
    evidenceEyebrow: 'Outcomes and working range',
    evidenceTitle: 'Design that moves into product results',
    evidenceIntro:
      'Confirmed outcomes, product range, and prototype craft show how I work through complexity.',
    evidence: [
      ['Business outcomes', 'Alibaba app redesign: MAU +45%', 'Website upgrade: retention +35%'],
      ['Range', 'Consumer, B2B, and SaaS', 'AI and real-time products'],
      [
        'Build boundary',
    ...
    careerTitle: 'One practice, expanded through different kinds of complexity',
    careerIntro:
      'Each stage extended the same practice: understanding people, clarifying systems, and making products easier to use.',
    timeline: [
      {
        tone: 'ux',
        date: '2010–2016',
        ...
        company: 'ZTE · 99bill',
        role: 'User research and mobile UX',
      },
      {
        tone: 'ui',
        date: '2016–2019',
        title: 'Consumer products at scale',
      ...
      },
      {
        ...
        title: 'AI and real-time products',
        company: 'Agora',
  ...
  zh: {
    ...
    capabilityIntro: '从理清复杂性，到建立系统、搭建原型并与团队一起推进产品。',
    capabilities: [
      {
        tone: 'ux',
        label: 'UX / 复杂度',
      ...
      },
      {
        ...
        label: 'AI / 设计 + 构建',
        title: '把设计与构建连成一个工作流',
        description: '用提示、原型与体验验证，让产品思路尽早被看见。',
      },
      {
        tone: 'leadership',
        label: '产品协作',
        title: '让关键判断被团队共同理解',
        description: '把方向、约束与品质标准带入产品协作。',
      },
    ] satisfies Capability[],
    evidenceEyebrow: '产品结果与工作方式',
    evidenceTitle: '让设计进入产品结果',
    evidenceIntro: '结果、产品类型与原型能力，共同构成杨静处理复杂问题的方式。',
    evidence: [
      ['业务结果', '阿里 App 改版：MAU +45%', '官网升级：留存 +35%'],
      ['能力跨度', 'C 端、B 端与 SaaS', 'AI 与实时互动产品'],
      ['原型能力', '可独立完成体验验证', '通过 Codex、Claude 快速搭建涵盖产品逻辑的交互式 HTML'],
    ],
    careerEyebrow: '五段经历',
    careerTitle: '一步一步，走到现在',
    careerIntro: '从用户研究、消费产品到复杂系统与 AI 产品，每段经历都在拓展同一件事：如何让产品更清楚。',
    timeline: [
      {
        tone: 'ux',
        date: '2010–2016',
