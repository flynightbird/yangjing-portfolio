  ...
  home: {
    ...
    projects: {
      ...
      meeting: {
        ...
        kind: '企业会议 aPaaS',
        title: 'Agora Meeting',
        proposition: '围绕人员、内容、角色与设备持续变化构建的多端实时协作系统。',
        role: '唯一产品设计师 · 2024-2026',
        status: '已覆盖四类终端上线',
        mediaLabel: '三项会议系统决策',
        action: '查看案例',
        stages: [
      ...
      aidx: {
        ...
        kind: '新加坡 AI 公司',
        title: 'AIDX',
        proposition: '为新加坡 AI 安全公司 AIDX 打造的全新线上官网，通过界面、信息结构与动效塑造品牌表达。',
      ...
      sttDemo: {
        ...
        kind: 'Build Lab',
        title: 'STT Demo',
        proposition: '让双语对话在实时转写与翻译中清晰呈现。',
    ...
    archive: {
      title: 'More C端用户设计作品',
      description: '更多设计作品，将以图片为主，轻量呈现产品、品牌与角色设计作品。',
      draftSlot: '草稿媒体槽位',
